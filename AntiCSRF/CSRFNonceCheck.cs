...
{
    public class CSRFNonceCheck : IAntiforgeryAdditionalDataProvider
    {
        private ApplicationDbContext _context;

        public CSRFNonceCheck(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public bool ValidateAdditionalData(HttpContext context, string additionalData)
        {
            ...
            if (dbToken.ExpiresOn < DateTime.Now)
                return false;
